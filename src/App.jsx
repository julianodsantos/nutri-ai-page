          ...
          <div className="space-y-8 animate-in slide-in-from-bottom-10 fade-in duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-8 py-4 rounded-xl text-lg font-bold transition-all shadow-[0_0_20px_rgba(16,185,129,0.4)] hover:shadow-[0_0_30px_rgba(16,185,129,0.6)] flex items-center justify-center gap-3"
              >
                <WhatsAppIcon className="w-6 h-6 fill-current" />
                Iniciar no WhatsApp
                <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
              <button className="px-8 py-4 rounded-xl text-slate-300 font-medium border border-slate-700 hover:bg-slate-800 transition-all hover:text-white">
                Ver Demonstração
              </button>
            </div>
          </div>
                ...
                <div className="flex-1 p-3 space-y-2 overflow-y-auto relative scrollbar-hide">
                   ...
                   <div className="flex justify-end">
                     <div className="bg-[#005c4b] rounded-lg rounded-tr-none p-1 max-w-[85%] shadow-sm">
                       <div className="bg-slate-800 h-40 w-56 rounded mb-1 overflow-hidden relative">
                         <img 
                         ...
                         />
                         <div className="absolute top-2 right-2 bg-black/60 px-2 py-0.5 rounded-full text-white text-[10px] font-medium">Hoje</div>
                       </div>
